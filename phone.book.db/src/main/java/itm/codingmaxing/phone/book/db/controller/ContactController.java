...
public class ContactController {
	...
	@CrossOrigin("*")
	@RequestMapping(path="/contact/update/email/{mobileNumber}", method=RequestMethod.PUT)
	public Contact updateContactEmail(@PathVariable long mobileNumber,@RequestBody String email) {
		logger.info("/contact/update/email/{mobileNumber}");
		logger.info("Updating Email... of mobile number "+ mobileNumber);
		return service.updateContactEmail(mobileNumber, email);
	}
}
